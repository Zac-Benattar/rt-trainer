...
\usepackage[a4paper, total={5.5in, 9.5in}]{geometry} % sets content area width and height respectively
...
\newcommand{\@librarycardnumber}[0]{}
\newcommand{\librarycardnumber}[1]{\renewcommand{\@librarycardnumber}{#1}}
